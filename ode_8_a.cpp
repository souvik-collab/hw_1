...
double f1(float t,float x,float y,float z) // x
{
    return (y);
}
double f2(float t,float x,float y,float z) // y
{
    return (a*cos(z)-b*y-sin(x));
}
double f3(float t,float x,float y,float z) // z
{
    return (c);
}
int main(void)
